...
//Fecha: 25/03/2021
//Compilacion: "gcc busquedaExponencial.c tiempo.c -o exp"(LINUX)
//Ejecucion: "./exp n"(LINUX)
//Ejecucion shell: ./exp.sh(LINUX)
//*****************************************************************
...
//Devuelve la posición de la primera aparición de X en el arreglo y realiza busqueda binaria
